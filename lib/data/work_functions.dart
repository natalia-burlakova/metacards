...
// class WorkMethods {
//   static WorkInProgress? getCurrentWork() {
...
//     var rnd = Random();
//     final emotionIndex = rnd.nextInt(cnst.AppData.metacards!.emotions.length);
//     return cnst.AppData.metacards!.emotions[emotionIndex];
//   }
...
//     String title = '';
//     final work = WorkMethods.getCurrentWork();
...
//   static Widget getWorkDeleteDialog(
...
//           child: YesNoDialog(
//             height: 210.0.a,
//             title: cnst.AppData.appUser?.creativeModeWork == null
...
//               } else {
//                 WorkMethods.deleteWork(cnst.AppData.appUser!.currentWorkIndex);
//               }
//               endFunc();
//             },
//           ),
