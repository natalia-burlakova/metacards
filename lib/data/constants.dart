...
class AppData {
  ...
  static Future<bool> getStaticData(context) async {
    // String strURL =
    //     "https://drive.google.com/uc?export=view&id=1Pv45MFDLBgb4YLAXcTU6nhcXfODk12hG";
    // try {
    //   final response = await http.get(Uri.parse(strURL));
    //   if (response.statusCode == 200) {
    //     var dd = json.decode(utf8.decode(response.bodyBytes));
    //     metacards = MetaCards.fromJson(dd);
    //   } else {
    //     String cardsRaw =
